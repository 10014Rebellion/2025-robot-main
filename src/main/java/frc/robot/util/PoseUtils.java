...
public class PoseUtils {
    ...
    public static Pose2d shiftPose(Pose2d originalPose, double forwardMeters, double rightMeters) {
        ...
        Translation2d translation = new Translation2d(forwardMeters, rightMeters)
                .rotateBy(originalPose.getRotation());
     ...
     * specified distance
     * forward and right relative to the rotated pose's new orientation.
     *
     ...
     */
    public static Pose2d shiftPose(Pose2d originalPose, Rotation2d rotationDelta, double forwardMeters,
            double rightMeters) {
        ...
        Translation2d translation = new Translation2d(forwardMeters, rightMeters)
                .rotateBy(rotatedPose.getRotation());
