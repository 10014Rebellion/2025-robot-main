...
// import static frc.vehicletrajectoryservice.VehicleTrajectoryServiceOuterClass.*;
...
//   /**
//    * Creates a {@link VehicleVelocityConstraint} from a {@link VehicleState}, useful for chaining
// a
...
//   /**
//    * Adds a waypoint to an existing {@link PathSegment.Builder} which is a continuation of a
//    * previously generated vehicle state. The pose and velocity of the waypoint are set to match
// the
//    * given vehicle state
//    *
//    * @param builder The {@link PathSegment.Builder}.
