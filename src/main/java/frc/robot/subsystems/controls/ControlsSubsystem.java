        ...
        public void initDriverController() {
                                                                ...
                                                                new ParallelDeadlineGroup(
                                                                                new ParallelCommandGroup(
                                                                                                ...
                                                                                                new SequentialCommandGroup(
                                                                                                                ...
                                                                                                                mWrist.setPIDCmd(
                                                                                                                                WristConstants.Setpoints.INTAKE))),
                                                                                mIntake.setPIDIntakePivotCmd(
                                                                                                IntakeConstants.IntakePivot.Setpoints.INTAKING),
                                                                                mIntake.setRollerCmd(
                                                                                                IntakeConstants.IntakeRoller.kIntakeSpeed)),
                                                                new WaitCommand(0.1),
                                                                new ParallelCommandGroup(
                                                                                mElevator.setPIDCmd(
                ...
                driverController
                                ...
                                .whileTrue(
                                                new ParallelCommandGroup(
                                                                mIntake.setPIDIntakePivotCmd(
                                                                                IntakeConstants.IntakePivot.Setpoints.ALGAEINTAKE),
                                                                mIntake.setIndexerCmd(-2),
                                                                mIntake.setRollerCmd(-8)))
                                .whileFalse(new ParallelCommandGroup(mIntake.setIndexerCmd(0),
                                                mIntake.setRollerCmd(0)));
                driverController
                                .y()
                                .whileTrue(
