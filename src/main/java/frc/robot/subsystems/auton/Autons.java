...
public class Autons {
    ...
    public Autons(Drive pDrive, Claw pClaw, Elevator pElevator, ElevatorPivot pPivot, OTBIntake pIntake) {
        this.mDrive = pDrive;
        this.mClaw = pClaw;
    ...
    public void configureNamedCommands() {
        NamedCommands.registerCommand("ReadySubsystemsL1", readySubsystems(1));
        NamedCommands.registerCommand("ReadySubsystemsL2", readySubsystems(2));
        NamedCommands.registerCommand("ReadySubsystemsL3", readySubsystems(3));
        NamedCommands.registerCommand("ReadySubsystemsL4", readySubsystems(4));
    ...
    private SequentialCommandGroup readySubsystems(int level) {
