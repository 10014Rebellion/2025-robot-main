...
public class OTBIntake extends SubsystemBase {
  ...
  public OTBIntake() {
    this.mRightPivotMotor =
        new SparkFlex(
            IntakeConstants.OTBIntake.kRightPivotID, IntakeConstants.OTBIntake.kMotorType);
    this.mRightRollerMotor =
        new SparkFlex(
            IntakeConstants.OTBIntake.kRightRollerID, IntakeConstants.OTBIntake.kMotorType);

    mRightPivotMotor.configure(
        IntakeConstants.OTBIntake.kRightPivotConfig,
        ResetMode.kResetSafeParameters,
        PersistMode.kNoPersistParameters);

    mRightRollerMotor.configure(
        IntakeConstants.OTBIntake.kRollerConfig,
        ResetMode.kResetSafeParameters,
        PersistMode.kNoPersistParameters);
