...
import static frc.robot.util.motor.PhoenixUtil.*;
...
public class ModuleIOTalonFXandFXS implements ModuleIO {
    ...
    public ModuleIOTalonFXandFXS(
        ...
        turnConfig.ExternalFeedback.AbsoluteSensorDiscontinuityPoint = 0; // CHANGE to 1 if doing encoder from 0 to 1.
                                                                          // This expects it to be from -0.5 to 0.5
