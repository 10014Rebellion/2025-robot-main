 ...
 */
public class ModuleIOSparkPIDF implements ModuleIO {
  ...
  public ModuleIOSparkPIDF(int module) {
    zeroRotation =
        switch (module) {
  ...
  public void setDriveVelocity(double velocityRadPerSec) {
    // Compute external PID control
    double pidOutput = driveController.calculate(driveEncoder.getVelocity(), velocityRadPerSec);
