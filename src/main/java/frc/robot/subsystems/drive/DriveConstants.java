...
public class DriveConstants {
  ...
  public static class PathGenConstants {
    public static final double kPControlX = 0.0;
    public static final double kIControlX = 0.0;
    public static final double kDControlX = 0.0;

    public static final double kPControlY = 0.0;
    public static final double kIControlY = 0.0;
    public static final double kDControlY = 0.0;
