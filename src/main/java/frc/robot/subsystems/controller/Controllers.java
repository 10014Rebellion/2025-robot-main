...
public class Controllers extends SubsystemBase {
    ...
    public void initDriverController() {
        ...
        driverController
                ...
                .whileTrue(
                        new GoToPose(
                                () -> mVision.getClosestReefScoringPose(distanceScoring,
                ...
                .whileTrue(
                        new SequentialCommandGroup(
                                new ParallelDeadlineGroup(
                                        ...
                                        new SequentialCommandGroup(
                                                new ElevatorPIDCommand((ElevatorConstants.Positions.PREINTAKE),
                                                        mElevator),
                                ...
                                new ParallelCommandGroup(
                                        ...
                                        new SequentialCommandGroup(
                                                new ElevatorPIDCommand((ElevatorConstants.Positions.POSTINTAKE),
                                                        mElevator),
                                                new ClawPIDCommand(ClawConstants.Wrist.Positions.INTAKE, mClaw)))))
                .whileFalse(
                        new ParallelCommandGroup(
    ...
    public void initOperatorButtonboard() {
        operatorButtonboard.button(ControllerConstants.Buttonboard.kReadyScoring)
                .whileTrue(
                        new ParallelCommandGroup(
        ...
        operatorButtonboard.button(ControllerConstants.Buttonboard.kScoreCoral)
                .whileTrue(
                        new ParallelCommandGroup(
                                new ClawPIDCommand(ClawConstants.Wrist.Positions.SCORE, mClaw),
                                new ElevatorPIDCommand(ElevatorConstants.Positions.SCORE, mElevator)).andThen(
                                        new InstantCommand(() -> ClawConstants.Claw.hasCoral = false)))
                .onFalse(
                        new SequentialCommandGroup(
                                new ClawPIDCommand(ClawConstants.Wrist.Positions.INTAKE, mClaw),
