...
// import frc.robot.util.arithmetic.GeomUtil;
// import frc.robot.util.telemetry.LoggedTunableNumber;
...
// public class AutonGoToPose extends Command {
...
//     static {
//         drivekP.initDefault(DriveConstants.drivebaseDriveKp);
...
//     private final ProfiledPIDController driveController = new ProfiledPIDController(0.0, 0.0, 0.0,
//             new TrapezoidProfile.Constraints(0.0, 0.0));
//     private final ProfiledPIDController thetaController = new ProfiledPIDController(0.0, 0.0, 0.0,
//             new TrapezoidProfile.Constraints(0.0, 0.0));

//     public AutonGoToPose(
...
//         driveVelocity = driveVelocity.interpolate(linearFF.get().times(DriveConstants.kMaxLinearSpeedMPS), linearS);
...
//         mDriveSubsystem.isAtPose = withinTolerance(driveTolerance.get(), new Rotation2d(thetaTolerance.get()));
...
//         return withinTolerance(0.05, new Rotation2d(1.0));
//     }
